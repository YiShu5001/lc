...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run PyBullet RL-LADRC retraining with random hover disturbance.")
    ...
    reward_curve_path = plot_reward_curve_collection(
        ...
        "Random-Hover-Disturbance PyBullet RL-LADRC Reward Curves",
    )
